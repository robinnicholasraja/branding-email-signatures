  ...
  switch (source) {
    case "trustpilot":
      return `<p style=margin:0;font-family:Inter,Arial,Helvetica,sans-serif;font-size:9px;line-height:11px;color:#616666>
                If you enjoyed our service, leave us a
                <a href=https://www.trustpilot.com/review/wellreceived.com style="font-family:Inter,Arial,Helvetica,sans-serif;font-size:9px;color:#00b67a;font-weight:600;text-decoration:none;border-bottom:1px solid #00b67a" target=_blank>review</a>
                on
                <img alt="Trustpilot logo" height=12 src=https://storage.googleapis.com/email_signatures/wellreceived/images/trustpilot-logo.png style=width:48px;height:12px;vertical-align:sub;font-size:16px;color:#494949 width=48>
              </p>`;
    case "upcity":
      return `<p style="margin:0;padding:0;font-size: 9px; line-height: 11px; font-weight: 500; color: #494949; opacity: 0.9;font-family: 'Inter', Arial, sans-serif;">
                If you enjoyed our service, leave us a <a target="_blank" href="https://upcity.com/profiles/wellreceived/portland-or/write-review" style="font-size: 9px; line-height: 11px; font-weight: 500; color:#D37728; opacity: 0.9;font-family: 'Inter', Arial, sans-serif;text-decoration:none;">review</a>  on 
                <img src="https://storage.googleapis.com/email_signatures/wellreceived/images/upcity-logo.png" width="53" height="14" style="width:53px;height:14px;
                vertical-align:bottom;">
              </p>`;
    case "google":
      return `<p style="margin:0;padding:0;font-size: 9px; line-height: 11px; font-weight: 500; color: #494949; opacity: 0.9;font-family: 'Inter', Arial, sans-serif;">
                If you enjoyed our service, leave us a <a target="_blank" href="https://www.google.com/maps/place//data=!4m3!3m2!1s0x5495a1218e4d75f9:0x461c945340ab3d69!12e1?source=g.page.m.dd._&amp;laa=lu-desktop-reviews-dialog-review-solicitation" style="font-size: 9px; line-height: 11px; font-weight: 500; color:#4A8DFF; opacity: 0.9;font-family: 'Inter', Arial, sans-serif;text-decoration:none;">review</a>  on 
                <img src="https://storage.googleapis.com/email_signatures/wellreceived/images/google-logo.png" width="38" height="13" style="width:38px;height:13px;
                vertical-align:middle;">
              </p>`;
    case "referral":
      return `<p style="margin:0;padding:0;font-size: 9px; line-height: 11px; font-weight: 500; color: #494949; opacity: 0.9;font-family: 'Inter', Arial, sans-serif;">
                Know someone who could use our service? <br> Refer a friend and get 
                <span style="font-size: 9px; line-height: 11px; font-weight: 700; color: #4A8DFF; opacity: 0.9;font-family: 'Inter', Arial, sans-serif;">$150 credit.</span> 
              </p>`;
    case "wecare":
      return `<p style="margin:0;padding:0;font-size: 9px; line-height: 11px; font-weight: 500; color: #494949; opacity: 0.9;font-family: 'Inter', Arial, sans-serif;">
                We're donating 1% to provide underserved<br> communities with access to healthcare.
              </p>`;
    default:
      return "";
  }
...
const WellReceivedSignatures = ({ name, position, email, phone, bookingLink, imageUrl, source }: Details) => {
  ...
  return `<html><head>
  <title>${name} - WellReceived</title><meta charset="UTF-8"></head><body style="font-family:'Inter', Arial, Helvetica, sans-serif; margin:0px; padding:0px; background:#FFFFFF;-webkit-font-smoothing: antialiased;" data-new-gr-c-s-check-loaded="14.1157.0" data-gr-ext-installed="">
    <table bgcolor=#F9FAFB border=0 cellpadding=0 cellspacing=0 style=font-family:Inter,Arial,Helvetica,sans-serif;background-color:#f9fafb;width:450px;min-width:450px;max-width:450px;margin:0;border-radius:40px;box-sizing:border-box;border-collapse:collapse>
      <tr>
